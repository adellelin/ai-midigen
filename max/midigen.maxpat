...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Dropbox (Personal)/MUSIC_AI_SETUP/Setup_COMPUTEX/COMPUTEX/1 max",
				"patcherrelativepath" : "../../../../Dropbox (Personal)/MUSIC_AI_SETUP/Setup_COMPUTEX/COMPUTEX/1 max",
				"type" : "PNG ",
				"implicit" : 1
			}
, 			{
